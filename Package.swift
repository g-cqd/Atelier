...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "KittyGit", dependencies: ["KittyFileTree", "KittySync"], swiftSettings: defaultSwiftSettings),
        ...
        .target(
            name: "KittySyntax",
            dependencies: ["KittyGrammar", "KittyParser", "KittyQuery", "KittyRenderer", "KittySync"],
