...
struct IntralineGranularityTests {
    ...
    func `objective c syntax tier keeps directives and strings whole`() {
        let byLine = SyntaxTokenizer.tokenRangesByLine(text: "@interface Foo : NSObject @\"a b\"", language: .objectiveC)
        #expect(byLine[0] == [0..<10, 10..<11, 11..<14, 14..<15, 15..<16, 16..<17, 17..<25, 25..<26, 26..<32])
    }
